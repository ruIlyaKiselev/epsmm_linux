...
#pragma omp parallel proc_bind(close)
    {
        for (int n = 0; n < Nt; n += 6) {
            ...
            for (int i = 2 - 7 * startFlag; i < 5 + 2 * (1 - startFlag); i++) {
                processLine(Nx, Ny, Nt, Sx, Sy, i + shift, tao2Hx2, tao2Hy2, tao2functionF, U0, U1, P);
            }

            for (int i = 2 - 6 * startFlag; i < 4 + 2 * (1 - startFlag); i++) {
                processLine(Nx, Ny, Nt, Sx, Sy, i + shift, tao2Hx2, tao2Hy2, tao2functionF, U1, U0, P);
            }
            ...
            for (int i = shift + 7 - 2 * startFlag; i < last_element - 3 - 2 * finishFlag; i++) {
                processLine(Nx, Ny, Nt, Sx, Sy, i, tao2Hx2, tao2Hy2, tao2functionF, U0, U1, P);
                processLine(Nx, Ny, Nt, Sx, Sy, i - 1, tao2Hx2, tao2Hy2, tao2functionF, U1, U0, P);
                processLine(Nx, Ny, Nt, Sx, Sy, i - 2, tao2Hx2, tao2Hy2, tao2functionF, U0, U1, P);
                processLine(Nx, Ny, Nt, Sx, Sy, i - 3, tao2Hx2, tao2Hy2, tao2functionF, U1, U0, P);
                processLine(Nx, Ny, Nt, Sx, Sy, i - 4, tao2Hx2, tao2Hy2, tao2functionF, U0, U1, P);
                processLine(Nx, Ny, Nt, Sx, Sy, i - 5, tao2Hx2, tao2Hy2, tao2functionF, U1, U0, P);
            }
