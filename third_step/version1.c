...
void processAlgorithm(int Nx, int Ny, int Nt, int Sx, int Sy, double tao2Hx2, double tao2Hy2, double tao, double* U0, double* U1, double* P) {
    ...
    for (int n = 0; n < Nt; n += 8) {
        ...
        processLine (Nx, Ny, Nt, Sx, Sy, Ny - 3, tao2Hx2, tao2Hy2, tao2functionF8, U1, U0, P);

        for (int i = 0; i < 2; i++) {
            processLine (Nx, Ny, Nt, Sx, Sy, Ny - 4, tao2Hx2, tao2Hy2, tao2functionF8, U0, U1, P);
        }

        for (int i = 0; i < 3; i++) {
            processLine (Nx, Ny, Nt, Sx, Sy, Ny - 5, tao2Hx2, tao2Hy2, tao2functionF8, U1, U0, P);
        }

        for (int i = 0; i < 4; i++) {
            processLine (Nx, Ny, Nt, Sx, Sy, Ny - 6, tao2Hx2, tao2Hy2, tao2functionF8, U0, U1, P);
        }

        for (int i = 0; i < 5; i++) {
            processLine (Nx, Ny, Nt, Sx, Sy, Ny - 7, tao2Hx2, tao2Hy2, tao2functionF8, U1, U0, P);
        }

        for (int i = 0; i < 6; i++) {
            processLine (Nx, Ny, Nt, Sx, Sy, Ny - 8, tao2Hx2, tao2Hy2, tao2functionF8, U0, U1, P);
        }
