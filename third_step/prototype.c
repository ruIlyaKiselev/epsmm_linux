...
void processAlgorithm(int Nx, int Ny, int Nt, int Sx, int Sy, double tao2Hx2, double tao2Hy2, double tao, double* U0, double* U1, double* P) {
    ...
    for (int n = 0; n < Nt; n += 6) {
        ...
        for (int k = 1; k <= 5; k++) {
            processLine (Nx, Ny, Nt, Sx, Sy, k, tao2Hx2, tao2Hy2, tao2functionF1, U0, U1, P);
        }

        for (int k = 1; k <= 4; k++) {
            processLine (Nx, Ny, Nt, Sx, Sy, k, tao2Hx2, tao2Hy2, tao2functionF1, U1, U0, P);
        }
        ...
        processLine (Nx, Ny, Nt, Sx, Sy, Ny - 3, tao2Hx2, tao2Hy2, tao2functionF6, U1, U0, P);

        for (int k = 0; k < 2; k++) {
            processLine (Nx, Ny, Nt, Sx, Sy, Ny - 4, tao2Hx2, tao2Hy2, tao2functionF6, U0, U1, P);
        }

        for (int k = 0; k < 3; k++) {
            processLine (Nx, Ny, Nt, Sx, Sy, Ny - 5, tao2Hx2, tao2Hy2, tao2functionF6, U0, U1, P);
        }

        for (int k = 0; k < 4; k++) {
            processLine (Nx, Ny, Nt, Sx, Sy, Ny - 6, tao2Hx2, tao2Hy2, tao2functionF6, U0, U1, P);
        }

        for (int k = 0; k < 5; k++) {
            processLine (Nx, Ny, Nt, Sx, Sy, Ny - 7, tao2Hx2, tao2Hy2, tao2functionF6, U0, U1, P);
        }
    }
}
